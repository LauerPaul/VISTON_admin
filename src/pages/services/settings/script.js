/**
* @vuedoc
* @module pages/services/settings
* @see @/pages/services/settings
*
* @version 1.0
...
const data = {
	...
	*/
	urlGetSettings: '/services/settings/',
	valid: true,
	loading: true,
	access: {
		edit: false
...
const methods = {
	...
	**/
	changeAll(index){
		this.$log.debug('page \'Services settings\' (@/pages/services/settings) - method init');
	...
	**/
	getSettings (lng = false){
		this.$log.info('page \'Services settings\' (@/pages/services/settings) - method init');
		...
		return this.axios({
            ...
            if(response.data.status == "ERROR") {
				this.$log.error('page \'Services settings\' (@/pages/services/settings) - AJAX error (GET)');
...
export default {
	...
	* @event module:pages/services/settings~Page <strong>Products settings</strong> mounted
	*/
	mounted: function(){
		this.$log.info('page \'Services settings\' (@/pages/services/settings) - mounted hook init');
